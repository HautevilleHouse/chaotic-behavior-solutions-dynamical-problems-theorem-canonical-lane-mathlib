import ChaoticBehaviorSolutionsDynamicalProblemsTheoremCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  constrainedStatement := "chaotic-behavior-solutions-dynamical-problems constrained theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
...
def ConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "chaotic_behavior_constrained" ∧
